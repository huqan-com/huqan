...
function stripCopulaSuffix(value = '') {
  ...
  words[lastIndex] = words[lastIndex].replace(/(dir|dur|tir|tur|d\u0131r|d\u00fcr|t\u0131r|t\u00fcr)$/i, '');
  ...
  verify(statement, opts = {}) {
    ...
    if (directEdge) {
      ...
      if (directEdge.relation === 'PREVENTS') {
        ...
        return this._verifyResult(statement, opts, { status: 'celiski', confidence: pConfidence }, [{
          kind: 'contradiction',
